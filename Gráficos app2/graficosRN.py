...
if __name__ == "__main__":
    ...
    arquivos = ["teste1.ReactNative.json", "teste2.ReactNative.json", "teste3.ReactNative.json"]
    ...
    # MÉDIAS
    plot_mean(time_list, cpu_list, "CPU (%)", "CPU Média - React Native App 2", f"{pasta}/CPU_media.png")
    plot_mean(time_list, fps_list, "FPS", "FPS Média - React Native App 2", f"{pasta}/FPS_media.png")
    plot_mean(time_list, ram_list, "RAM (MB)", "RAM Média - React Native App 2", f"{pasta}/RAM_media.png")

    print("Gráficos do App 2 (React Native) gerados com sucesso!")
